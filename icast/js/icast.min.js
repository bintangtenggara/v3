...
else if(settings.version==2){audio.src=settings.URL+settings.streampath;settings.src=audio.src;if(settings.enable_cors==!0){var dataURL=settings.cors+"/"+settings.URL+"/stats?sid="+settings.stream_id+"&json=1&callback=?";var hisURL=settings.cors+"/"+settings.URL+"/played?sid="+settings.stream_id+"&type=json&callback=?"}
