...
<html>
	<head>
		...
		<title>Default - Modern Radio Player with Playlist</title>
       
		<link rel="stylesheet" type="text/css" href="css/jquery.mCustomScrollbar.css" media="all" /><!-- playlist scroll -->
	    <link id="mrp-css" rel="stylesheet" type="text/css" href="css/default.css" />
       
        <script src="js/jquery-3.2.1.min.js"></script>
        <script src="js/new.js?4"></script>			
        <script type="text/javascript">
            ...
            jQuery(document).ready(function($){
                ...
                var settings = {
                    ...
                    defaultHistoryArtwork: "https://is1-ssl.mzstatic.com/image/thumb/Music122/v4/b7/ea/cf/b7eacfc6-51b4-6140-33bc-84c3c44df1e2/717124175674.png/592x592bb.webp",
	...
	<body>
        ...
        <div id="mrp-wrapper">
       		...
       		<div class="mrp-player-holder">
                ...
                <div class="mrp-player-content">

                    <div class="mrp-share-wrapper mrp-contr-btn">

                        <div class="mrp-share-holder">
                            <div class="mrp-share-item mrp-contr-btn" data-type="tumblr" data-tooltip="Share On Tumblr">
                            ...
                            <div class="mrp-share-item mrp-contr-btn" data-type="twitter" data-tooltip="Share On Twitter">
                            ...
                            <div class="mrp-share-item mrp-contr-btn" data-type="facebook" data-tooltip="Share On Facebook">
                            ...
                            <div class="mrp-share-item mrp-contr-btn" data-type="whatsapp" data-tooltip="Share On WhatsApp">
                    ...
                    <div class="mrp-popup-toggle mrp-contr-btn" data-tooltip="Expand">
                        <svg viewBox="0 0 448 512" class="svg-inline--fa fa-expand-arrows-alt fa-w-14 fa-3x"><path d="M448 344v112a23.94 23.94 0 0 1-24 24H312c-21.39 0-32.09-25.9-17-41l36.2-36.2L224 295.6 116.77 402.9 153 439c15.09 15.1 4.39 41-17 41H24a23.94 23.94 0 0 1-24-24V344c0-21.4 25.89-32.1 41-17l36.19 36.2L184.46 256 77.18 148.7 41 185c-15.1 15.1-41 4.4-41-17V56a23.94 23.94 0 0 1 24-24h112c21.39 0 32.09 25.9 17 41l-36.2 36.2L224 216.4l107.23-107.3L295 73c-15.09-15.1-4.39-41 17-41h112a23.94 23.94 0 0 1 24 24v112c0 21.4-25.89 32.1-41 17l-36.19-36.2L263.54 256l107.28 107.3L407 327.1c15.1-15.2 41-4.5 41 16.9z"></path></svg>
                    </div> 
                    ...
                    <div class="mrp-volume-toggle">
                        ...
                        <div class="mrp-volume-seekbar">
                            ...
                            <div class="mrp-volume-level"><div class="mrp-volume-drag"></div></div>
                        </div>
                ...
                <div class="mrp-preloader"></div>
                  
            </div>

            <div class="mrp-playlist-holder">

                <div class="mrp-playlist-bar">
                    <div class="mrp-history-title mrp-title-active">History</div>
                    <div class="mrp-station-title">Stations</div>
                </div>

                <div class="mrp-history-inner">
                    <div class="mrp-history-content"></div>
                </div>

                <div class="mrp-playlist-inner">
                    <div class="mrp-playlist-content"></div>
                </div>

            </div>

            <div class="mrp-tooltip"></div>  

        </div>  

        <!-- PLAYLIST LIST -->
        <div id="mrp-playlist-list">

            <div class="mrp-playlist-item playlist1" data-type="icecast" data-radio-url="https://sv.stri.my.id/radio/8360/rbtfm" data-radio-title="Bintang Tenggara 56k" data-radio-thumb="https://lastfm.freetls.fastly.net/i/u/300x300/f69c7be1aa497aaa87f40d2306c4c355.png"></div>

            <div class="mrp-playlist-item playlist2" data-type="shoutcast" data-radio-url="https://ssg.streamingmurah.com:9560/;" data-radio-title="Bintang Tenggara 64k" data-radio-thumb="https://lastfm.freetls.fastly.net/i/u/300x300/f69c7be1aa497aaa87f40d2306c4c355.png"></div>
...
<!--
        <a href="#" onclick="player.loadPlaylist('.playlist6');return false;">load playlist 6</a>-->
